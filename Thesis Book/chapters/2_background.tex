...
\end{figure}
\noindent In Fig. 2.6 the problem of hyperspectral data, curse of dimensionality is present in image band number 18. From image band 18, the accuracy of the classification task is gradually decreasing as the train sample of the experiment remains constant.