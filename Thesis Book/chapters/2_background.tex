...
greater than about 30 cm (Fig. 2.1).
\begin{figure}[H]
	\begin{center}
...
\end{figure}
\noindent Fig. 2.3 shows a reflectance spectra for some important minerals. Field and laboratory spectrometers usually measure reflectance at many narrow,
...
Table 2.1. The orbits were near polar and sun synchronous – i.e., the orbital plane
